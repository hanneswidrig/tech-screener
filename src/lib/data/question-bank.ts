...
export const questionBank = (): Record<TopicKey, QuestionBank[]> => ({
	...
	java: [
		...
		{
			question: 'What is a static variable? How many times is a static variable instantiated?',
			answer: '',
		},
		...
		{
			question: 'What are some core JDBC components? What do they do? When would you use JDBC?',
			answer: '',
		},
	...
	react: [
		...
		{
			question: 'Are you familiar with the lifecycle methods? (name and explain atleast 3 methods)',
			answer: '',
		},
